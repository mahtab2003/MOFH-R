		...
		<div class="card mb-2">
			...
			<div class="card-footer">
				<div class="d-flex justify-content-between align-items-center">
					<div><?= $this->ui->text('showing_text') ?> <?php if ($start === 0 AND $end === 0): ?> 0 <?php else: ?> <?= $start + 1 ?> <?php endif ?> <?= $this->ui->text('to_text') ?> <?= $end ?? 0?> <?= $this->ui->text('of_text') ?> <?= count($list) - 1 ?> <?= $this->ui->text('entites_text') ?></div>
