...
<head>
	...
	<title>Registration - Installation</title>
...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="card mb-2">
			...
			<div class="card-body">
				<form action="<?= $this->base_url.'index.php/i/step3' ?>" method="POST">
					<div class="mb-2">
					...
					<div class="mb-2">
						...
						<input type="text" name="confirm_password" class="form-control" placeholder="*********" required>
					</div>
