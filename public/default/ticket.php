		...
		<div class="row">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item"><a href="<?= base_url('t/ticket') ?>"><?= $this->ui->text('support_link_text') ?></a></li>
	...
	<div class="container-xl">
		<div class="card mb-2">
			<div class="card-header">
				<h3 class="card-title"><?= $this->ui->text('ticket_text') ?></h3>
			</div>
				...
				<table class="table">
					<thead>
						<tr>
							...
							<th width="60%"><?= $this->ui->text('subject_tab_text') ?></th>
			...
			<div class="card-footer">
				<div class="d-flex justify-content-between align-items-center">
					...
					<ul class="pagination pagination-sm float-right m-0">
						...
						if ($page > 0):
							$page1 = $page - 1;
							$link1 = base_url('t/tickets?page='.$page1);
							$status1 = '';
						else:
							$link1 = '#';
							$status1 = 'disabled';
						...
						if($page < $i):
							$page2 = $page + 1;
							$link2 = base_url('t/tickets?page='.$page2);
							$status2 = '';
						else:
							$link2 = '#';
							$status2 = 'disabled';
