			...
			<div class="card-body px-3 py-1">
				<div class="row">
					<div class="col-md-4 px-2 py-2">
						<a href="<?= base_url('h/view_account/'.$info['username'].'?cpanel_redirect=true') ?>" class="btn d-block btn-success <?php if ($info['status'] !== 'active'): ?> disabled<?php endif ?>" target="_blank"><?= $this->ui->text('cpanel_btn_text') ?></a>
					</div>
					<div class="col-md-4 px-2 py-2">
						<a href="https://filemanager.ai/new/#/c/ftpupload.net/<?= $info['username'] ?>/<?= base64_encode(json_encode(['t' => 'ftp', 'c' => ['v' => 1, 'p' => $info['password'], 'i' => '/htdocs/']])) ?>" class="btn d-block btn-warning <?php if ($info['status'] !== 'active'): ?> disabled<?php endif ?>" target="_blank"><?= $this->ui->text('file_manager_btn_text') ?></a>
					</div>
					<div class="col-md-4 px-2 py-2">
